...
interface CreatePartnerReviewScreenProps {
  partner: any;
  onBack: () => void;
}

export function CreatePartnerReviewScreen({ partner, onBack }: CreatePartnerReviewScreenProps) {
      ...
      <form onSubmit={handleSubmit} className="px-4 py-8 space-y-8">
        ...
        <div>
          ...
          <textarea
            ...
            placeholder="Como foi o atendimento? Produtos de qualidade? Preços justos?"
            rows={6}
          ...
          <p className="text-xs text-[var(--petmatch-text-muted)] mt-2">
            Compartilhe detalhes sobre produtos, atendimento e preços
          </p>
        </div>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
          ...
          <ul className="text-xs text-[var(--petmatch-text-muted)] space-y-1">
            ...
            <li>• Descreva os produtos e serviços</li>
            <li>• Mencione qualidade e preços</li>
