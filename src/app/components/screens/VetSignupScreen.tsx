...
export function VetSignupScreen({ onBack, onNavigate }: VetSignupScreenProps) {
      ...
      <form onSubmit={handleSubmit} className="px-4 py-6 space-y-6">
        ...
        <div className="border-t-2 border-gray-100 pt-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-[var(--petmatch-text)] mb-2">
                Comprovante CRMV (opcional)
              </label>
              <div className="border-2 border-dashed border-gray-300 rounded-xl p-4 text-center cursor-pointer hover:border-[var(--petmatch-primary)] transition-colors">
                <Camera className="mx-auto text-gray-400 mb-2" size={24} />
                <span className="text-sm text-gray-500">Clique para anexar documento</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
          <div className="flex items-start gap-3">
            ...
            <label htmlFor="privacy" className="flex-1 text-sm text-[var(--petmatch-text)]">
              Concordo com o tratamento dos meus dados pessoais para fins de cadastro e contato na plataforma PetMatch, conforme a{' '}
          ...
          <p className="text-xs text-[var(--petmatch-text-muted)] mt-3 flex items-start gap-2">
            ...
            <span>
              Você pode revogar este consentimento a qualquer momento através das configurações do seu perfil.
            </span>
          </p>
        </div>
